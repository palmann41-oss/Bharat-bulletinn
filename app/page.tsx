    ...
    <div className="min-h-screen bg-zinc-50 font-sans">
      ...
      <header className="bg-white border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <a href="https://www.facebook.com/share/1SdiZiAL4J/?mibextid=wwXIfr" target="_blank" className="px-4 py-2 bg-blue-600 text-white rounded-full text-sm font-semibold">📘 Facebook</a>
            <a href="#mobile-app" className="px-4 py-2 bg-orange-500 text-white rounded-full text-sm font-semibold">📱 App</a>
          </div>
        </div>
      </header>
      ...
      <section id="mobile-app" className="bg-gradient-to-r from-red-600 to-orange-500 py-16 text-white text-center">
        ...
        <div className="flex justify-center mb-8">
          <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://expo.dev/@your-username/bharat-bulletin" alt="QR Code" className="w-48 h-48" />
        </div>
        <a href="https://expo.dev/@your-username/bharat-bulletin" target="_blank" className="bg-white text-red-600 px-8 py-3 rounded-2xl font-bold text-lg">📱 Download App</a>
      </section>
